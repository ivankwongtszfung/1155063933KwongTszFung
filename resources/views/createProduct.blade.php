...
<body  ng-app="myApp" ng-controller="ctrl">
  ...
  <h1>Create Product</h1>
     <div>
          <form id="target" name="myForm" ng-submit="submitMyForm()" enctype="multipart/form-data" novalidate>
          ...
          {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <select name="Catid" class="form-control"  ng-model="myData.Catid" ng-options="cat.Catid as cat.Catname for cat in category"></select>
...
<!--             <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div ng-messages="myForm.Sku.$error" ng-show="myForm.Sku.$touched" style="color:maroon" role="alert">
                <div ng-cloak class="stringRequired" ng-message="required">You did not enter a field</div>
                <div ng-cloak class="skuLength" ng-message="minlength">sku contains 7 character only</div>
                <div ng-cloak class="skuLength" ng-message="maxlength">sku contains 7 character only</div>
              </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input ng-minlength="10" ng-maxlength="60" type="Name" class="form-control" name="Barcode" ng-model="myData.Barcode" required>
              <div ng-messages="myForm.Barcode.$error" ng-show="myForm.Barcode.$touched" style="color:maroon" role="alert">
                ...
                <div ng-cloak class="skuLength" ng-message="maxlength">Barcode should not be exceed 60 characters only</div>
              </div>
            </div>
             ...
             <div class="form-group">
              ...
              <div ng-messages="myForm.Quanity.$error" ng-show="myForm.Quanity.$touched" style="color:maroon" role="alert">
                <div ng-cloak class="stringRequired" ng-message="required">You did not enter a field</div>
                <div ng-cloak class="stringNumber" ng-message="number">Your field is not a number</div>
                <div ng-cloak class="stringMin" ng-message="min">Quanity should be larger than 0</div>
                <div ng-cloak class="stringMax" ng-message="max">Quanity should not more than 10</div>
                <div ng-cloak class="stringMax" ng-message="step">Quanity should be integer</div>
              </div>
            </div>
            <div class="form-group">
              <label for="image">Select image to upload:</label>
              <input type="file" name="image" id="image" ng-model="myData.image">
            </div>
