...
<html>
  ...
  <nav class="navbar navbar-default navbar-static">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown open"><a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0)"><span class="icon-lock"></span><span class="glyphicon glyphicon-shopping-cart"></span></a>
    ...
    <div class="container">
      ...
      <div class="col-sm-9 grid_product">
	        <div class="product_photo">
              <img src="{{asset('img/food.png')}}">
            </div>
            <div class="name">
              Product name:<a href="/Product-ARROWHEAD-MILLS/ORGANIC-SPLIT-GREEN-PEAS/p/BP_426705" data-ajax="false" data-link="/Product-ARROWHEAD-MILLS/ORGANIC-SPLIT-GREEN-PEAS/p/BP_426705">ARROWHEAD MILLS ORGANIC SPLIT GREEN PEAS</a>
            </div>
            <div class="price">Price:$123</div>
            <div class="add_cart">
